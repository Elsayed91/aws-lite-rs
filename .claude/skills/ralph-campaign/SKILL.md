...
- What should Ralph build? (e.g., "Add EC2, Lambda, and DynamoDB APIs")
- Desired campaign name (suggest one derived from the task, e.g., `aws-compute`)
...
- **Each task line lists specific work** — e.g., `1.2: ecs ListClusters + DescribeClusters + integration tests`
